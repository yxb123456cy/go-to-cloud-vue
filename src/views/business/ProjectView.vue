...
import { IconDelete, IconEdit, IconHistory, IconPlayArrow, IconPlus, IconRefresh } from '@arco-design/web-vue/es/icon'
...
function viewBuilds(project: Project) {
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      >
        ...
        <template #actions="{ record }">
          <a-space>
            <a-button type="text" size="small" :loading="buildingProjects.includes(record.id)" @click="buildProject(record)">
              <template #icon>
                <IconPlayArrow />
              </template>
              构建
