  ...
  <div class="min-h-screen flex">
    ...
    <div class="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-20 xl:px-24">
      <div class="mx-auto w-full max-w-sm lg:w-96">
        ...
        <a-form
          ref="formRef" :model="registerForm" :rules="rules" layout="vertical" class="space-y-6"
          @submit="handleSubmit"
        >
          <a-form-item field="username" label="用户名" class="mb-4">
            <a-input
              v-model="registerForm.username" placeholder="请输入用户名" size="large"
          ...
          <a-form-item field="email" label="邮箱地址" class="mb-4">
            <a-input
              v-model="registerForm.email" placeholder="请输入邮箱地址" size="large"
              class="h-12 rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500"
            >
              <template #prefix>
          ...
          <a-form-item field="password" label="密码" class="mb-4">
            <a-input-password
              v-model="registerForm.password" placeholder="请输入密码" size="large"
              class="h-12 rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500"
            >
              <template #prefix>
          ...
          <a-form-item field="confirmPassword" label="确认密码" class="mb-4">
            <a-input-password
              v-model="registerForm.confirmPassword" placeholder="请再次输入密码" size="large"
              class="h-12 rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500"
            >
              <template #prefix>
                <IconLock class="text-gray-400" />
          ...
          <a-form-item field="agreement" class="mb-6">
            <a-checkbox v-model="registerForm.agreement" class="text-sm text-gray-600">
              我已阅读并同意
              <a-link class="text-blue-600 hover:text-blue-500">
                服务条款
              </a-link>
              和
              <a-link class="text-blue-600 hover:text-blue-500">
